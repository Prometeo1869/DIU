...
public class Main extends Application {
     ...
     * Constructor
     */
    public Main() throws ExcepcionPerson {
        ...
        try {
            rep = new PersonRepositoryImpl();
            person = new PersonModelo();
            person.setRepos(rep);
            for (PersonVO pvo : person.obtenerListaPerson()) {
                Person p;
                p = PersonConvert.convertToPerson(pvo);
                personData.add(p);
            }
        } catch (ExcepcionPerson e) {
            throw new ExcepcionPerson("No se conecta");
        }
    }
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.getIcons().add(new Image("file:resources/images/agenda_ico.png"));
    ...
    public void showPersonOverview() {
        try {
            ...
            controller.setPersonModelo(this.person);
